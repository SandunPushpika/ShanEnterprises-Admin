            ...
            <div className="flex justify-between items-start gap-3 mb-4">
                <div className="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                        <h3
                            className="text-lg font-bold text-secondary tracking-tight truncate"
                            title={driver.name}
                        >
                            {driver.name}
                        </h3>

                        <div className="flex items-center gap-1 text-xs text-muted font-medium mt-0.5 min-w-0">
                            <IdCard className="w-3.5 h-3.5 text-primary/70 shrink-0" />
                ...
                <span
                    className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold border shadow-sm shrink-0 ${STATUS_BADGE[driver.status] ?? STATUS_BADGE.Pending
                        }`}
                >
